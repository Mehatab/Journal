...
public class RichEditText extends AppCompatEditText {
    ...
    //话题#符号
    private static final String TAG_REGEX = "^#{1,6}[ \\t]+";
...
//                        Selection.setSelection(getText(), lastPos, lastPos + tag.length());
    ...
    public void replaceTopicImage() {
        ...
        while (matcher.find()) {
            builder.setSpan(new ImageSpan(getContext(), R.drawable.ic_pencil), matcher.start(), matcher.end(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        setText(builder);
