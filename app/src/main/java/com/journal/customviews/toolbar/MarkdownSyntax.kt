...
sealed class SymmetricMarkdownSyntax(val prefix: String, val suffix: String = prefix) :
    MarkdownSyntax() {
...
sealed class CompoundableMarkdownSyntax(prefix: String) :
    SymmetricMarkdownSyntax(prefix, suffix = "") {
    /**
    ...
    override fun insert(editText: EditText) {
        ...
        editText.setSelection(
            selectionStartCopy + quoteSyntaxLength,
            selectionEndCopy + quoteSyntaxLength
        )
...
object ThematicBreak : MarkdownSyntax() {
    override fun insert(editText: EditText) {
        ...
        val currentLine = text.subSequence(
            layout.getLineStart(currentLineIndex),
            layout.getLineEnd(currentLineIndex)
        )
