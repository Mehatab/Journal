...
import com.journal.databinding.BottomSheetRichEditorBinding;

public class BottomSheet extends BottomSheetDialogFragment {


    BottomSheetBehavior bottomSheetBehavior;
    BottomSheetRichEditorBinding bi;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //inflating layout
        View view = View.inflate(getContext(), R.layout.bottom_sheet_rich_editor, null);
