...
data class MarkdownHintStyles(
    ...
    val blockQuoteIndentationRuleColor: Int = color(
        context,
        R.color.markdown_blockquote_indentation_rule
    ),
    ...
    val blockQuoteVerticalRuleStrokeWidth: Int = dimensPx(
        context,
        R.dimen.markdown_blockquote_vertical_rule_stroke_width
    ),
    ...
    val listBlockIndentationMargin: Int = dimensPx(
        context,
        R.dimen.markdown_text_block_indentation_margin
    ),
    ...
    @Px
    val horizontalRuleStrokeWidth: Int = dimensPx(
        context,
        R.dimen.markdown_horizontal_rule_stroke_width
    ),
...
val dimensPx =
    { context: Context, dimenResId: Int -> context.resources.getDimensionPixelSize(dimenResId) }
